...
export default function TOC() {
  ...
  return (
    <Nav variant="pills" id="wd-toc">
      <Nav.Item> <Nav.Link as={Link} to="Labs" id="wd-a"
      > Labs </Nav.Link> </Nav.Item>
      ...
      <Nav.Item> <Nav.Link href="https://github.com/anshuman-raina/kambaz-react-web-app" target="_blank"> My GitHub </Nav.Link> </Nav.Item>
    </Nav>
  );
}
