...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <a id="wd-retrieve-completed-todos" className="btn btn-primary float-end" href={`${REMOTE_SERVER}/lab5/todos/${todo.id}/delete`}>
            ...
            <a href={`${REMOTE_SERVER}/lab5/todos/${todo.id}/description/${todo.description}`} className="btn btn-primary float-end">
            ...
            <a href={`${REMOTE_SERVER}/lab5/todos/${todo.id}/completed/${todo.completed}`} id="wd-update-todo-completed"
