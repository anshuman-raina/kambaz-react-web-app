...
tag to tell browsers to render the gaps.
  ...
  <li>Crack 2 eggs.</li>
    <li>Whisk in a bowl with some salt and pepper.</li>
    <li>Pour in a pan and heat accordingly to get the best french omelette</li>
  </ol>
...
<h5 id="wd-buttons">Buttons</h5>
            <button id="wd-all-good" onClick={() => alert("Trying my test!!!")} type="button">
                Hello World!
            </button>
...
<h4>Anchor tag</h4>
            ...
            Code Repository on
            <a id="wd-github" href="https://github.com/anshuman-raina/kambaz-react-web-app"> GitHub</a>
